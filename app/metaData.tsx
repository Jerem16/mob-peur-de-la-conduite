...
const metadata: Metadata = {
    ...
    icons: {
        apple: [
            ...
            {
                url: "/mob-peur-de-la-conduite/img/favicon/apple-touch-icon.png",
            },
        ],
        icon: [
            {
            ...
            {
                url: "/mob-peur-de-la-conduite/img/favicon/favicon-16x16.png",
                sizes: "16x16",
                type: "image/png",
            },
            {
                url: "/mob-peur-de-la-conduite/img/favicon/icons/favicon-32x32.png",
                sizes: "32x32",
                type: "image/png",
            },
            {
                url: "/mob-peur-de-la-conduite/img/favicon/icons/android-chrome-192x192.png",
                sizes: "192x192",
                type: "image/png",
            },
            {
                url: "/mob-peur-de-la-conduite/img/favicon/icons/android-chrome-512x512.png",
                sizes: "512x512",
                type: "image/png",
            },
            {

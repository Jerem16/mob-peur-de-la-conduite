...
export const metadata: Metadata = {
    ...
    description:
        "Consultez les mentions légales du site Peur de la conduite : informations sur l’éditeur du site, le responsable de publication, le webmaster, l’hébergement et les droits liés aux données personnelles (RGPD).",
    alternates: {
    ...
    openGraph: {
        ...
        description:
            "Toutes les informations légales concernant Peur de la conduite : éditeur, responsable du site, hébergeur AWS, politique de confidentialité et RGPD.",

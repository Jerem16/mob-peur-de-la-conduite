...
export const metadata: Metadata = {
    ...
    description:
        "Découvrez des articles dédiés à la peur de conduire : conseils pratiques, gestion du stress, dépassement des blocages et préparation à la conduite en toute confiance. Par Mounir Bouakkaz, coaching conduite et anti-amaxophobie au Havre.",
    alternates: {
    ...
    openGraph: {
        title: "Blog | Peur de la conduite",
        description:
            "Conseils et articles pour vaincre la peur de conduire, gérer le stress au volant et progresser en toute sérénité. Par Mounir Bouakkaz, coach conduite au Havre.",

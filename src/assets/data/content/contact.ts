...
export const contactAnnouncements: ContactAnnouncement[] = [
    ...
    {
        message:
            "<strong>Vous pouvez également me contacter via le formulaire.</strong>",
    },
];

export const contactDetails: ContactDetail[] = [
    {
        svg: "/mob-peur-de-la-conduite/img/contact/icon/clock.svg",
        text: "Du Lundi au Dimanche, 07h - 20h",
        alt: "Horaires",
    },
    {
        svg: "/mob-peur-de-la-conduite/img/contact/icon/phone.svg",
        text: "+33 6 74 25 91 81",
        link: "tel:+33674259181",
        alt: "Téléphonne",
    },
    {
        svg: "/mob-peur-de-la-conduite/img/contact/icon/mail.svg",
        text: "Envoyez-moi un mail",
        link: "mailto:contact.peurdelaconduite@gmail.com",
        alt: "Mail",
    },
    {
        svg: "/mob-peur-de-la-conduite/img/contact/icon/location.svg",
...
export const socialLinks: SocialLink[] = [
    ...
    {
        svg: "TikTok",
        link: "https://www.tiktok.com/@peur.de.la.condui?_t=ZN-8taHCRDnmnH&_r=1",
    },
    {
        svg: "Instagram",
    ...
    {
        svg: "Facebook",
        link: "https://www.facebook.com/profile.php?id=61567260421073&mibextid=LQQJ4d&rdid=QuSBUDcJheDerFqF&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1D3HEm7Z4G%2F%3Fmibextid%3DLQQJ4d",
    },
    {
        svg: "Linkedin",
        link: "https://www.tiktok.com/@peur.de.la.condui?_t=ZN-8taHCRDnmnH&_r=1",
